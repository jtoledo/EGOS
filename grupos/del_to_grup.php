<?php
if($form==3 and $stock!=1) //CUANDO NO HAY REQUERIMIENTOS EN EL PAQUETE SE CONSULTA EL PRIMER REQUERIMIENTO DEL CATALOGO CCPTREQUE..
{
$fila=get_requerimiento();
...
else // CUANDO SE NEECESITA GURADAR UN REQUERIMIENTO PERSONALIZADO
{
$fila=consul_requerimientos($idrequerimiento);
...
<form name="reque" action="" onSubmit="add_reque_paq(2); return false"  class="formu">
