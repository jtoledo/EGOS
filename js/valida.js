...
var msg="\n     Sistema integral de Informacion EGOS SII 1.0  \n  Exportadora de granos y Oleaginosas S.A de C.V";
...
function llenar_campo_recursos(){
...
if (document.captura.interes_moratorio.value.length==0)
	{ 
document.captura.interes_moratorio.value=interes_normal*2;
interes_moratorio=document.captura.interes_moratorio.value;

document.captura.interes_moratorio_a.value=interes_moratorio*12;
...
interes_normal_a=interes_normal*12;




document.captura.interes_normal_a.value=interes_normal_a;
//document.captura.interes_moratorio_a.value=interes_moratorio_a;



numero1=document.captura.interes_normal_a.value;
numero2=document.captura.interes_moratorio_a.value;

numero3=document.captura.interes_normal.value;
numero4=document.captura.interes_moratorio.value;



if (!/^([0-9])*[.]?[0-9]*$/.test(numero1))
{
   alert("El valor " + numero1 + " no es un número valido");
   document.captura.interes_normal_a.value="";
}


if (!/^([0-9])*[.]?[0-9]*$/.test(numero2))
{
   alert("El valor " + numero2 + " no es un número valido");
   document.captura.interes_moratorio_a.value="";
}

if (!/^([0-9])*[.]?[0-9]*$/.test(numero3))
{
   alert("El valor " + numero3 + " no es un número valido");
   document.captura.interes_normal.value="";
}
if (!/^([0-9])*[.]?[0-9]*$/.test(numero4))
{
   alert("El valor " + numero4 + " no es un número valido");
   document.captura.interes_moratorio.value="";
}
...
function cambiacolor_over(celda){ celda.style.backgroundColor="#CCCC33" } 
function cambiacolor_out(celda){ celda.style.backgroundColor="#ffffff" }


function cambiacolor_over_credito(celda){ celda.style.backgroundColor="#FFCA95" } 
function cambiacolor_out_credito(celda){ celda.style.backgroundColor="#ffffff" }



function cambiacolor_over_doc(celda){ celda.style.backgroundColor="#ffffff" } 
function cambiacolor_out_doc(celda){ celda.style.backgroundColor="#E2D29C" }
