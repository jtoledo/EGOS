...
//Como todas las pesadas forzosamente son del mismo tamaño solo se recorre una sola vez
var contador=0;
var conta_kgs=0;
var tongas=0;
...
var preciox_kg;
var retencion_p;
idproductor = document.getElementById('idproductor').value;	
...
ajax.send("id_catalogo="+id_catalogo+"&form="+form+"&idproductor="+idproductor)

}

function cc_get_productor(id_productor,form){
var preciox_kg;
var retencion_p;
id_catalogo = document.getElementById('id_catalogo').value;	
if(id_catalogo.length==0)
{
		//si no hay seleccionado producto abortamos
		return;
}
form=1;
...
ajax.send("id_catalogo="+id_catalogo+"&form="+form+"&idproductor="+id_productor)
...
function verificaMonto(can_val,monto_actual)
{
   ...
   if (parseFloat(val1)<parseFloat(val2)) {
		alert("No esta permitido modificar a una cantidad Menor, el monto de crédito")
		can_val.value=val2
   }
}
...
/*FORMATO DE NUMEROS COMO NUMBER_FORMAT*/
 ...
 /* Modificado por Ultiminio Ramos G */
   /* Fecha: 2012-04-05 */
   /* Para formatear el número separado con comas para los miles y punto para los decimales */
