...
var VentanaModal = {
	...
	cerrar: function(id_cliente) {
		document.location.href="info_clientes.php?id_cliente="+id_cliente;
		this.ventana.style.display = "none";
		this.csombra.style.display = "none";
		this.fondo.style.display = "none";
	},
	
	cerrar_servicio: function(id_servicio) {
		document.location.href="alta_concepto.php?id_servicio="+id_servicio;
		this.ventana.style.display = "none";
		this.csombra.style.display = "none";
		this.fondo.style.display = "none";
	},
	
	cerrar_diagnostico: function(id_servicio) {
		document.location.href="alta_diag.php?id_servicio="+id_servicio;
		this.ventana.style.display = "none";
		this.csombra.style.display = "none";
		this.fondo.style.display = "none";
	},

	cerrar_diagnostico_f: function(id_servicio) {
		document.location.href="servicios_folio.php?id_servicio="+id_servicio;
		this.ventana.style.display = "none";
		this.csombra.style.display = "none";
		this.fondo.style.display = "none";
	},
...
function abrirVentana(pagina, ancho, alto, nombre) {
    ...
    + "</td></tr><tr><td>"
    + "<iframe name='" + nombre + "' src='" + pagina + "' width='100%' height='" + (parseInt(alto) - 30) + "' frameborder='0' scrolling='YES'></iframe>"
    + "</td></tr></table>";
