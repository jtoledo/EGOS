...
<form name="captura" action="" onSubmit="cc_autoriza_solicitud_grupo(3); return false" class="formu">  
...
<table width="60%" border="0">
    ...
    <tr>
      <td><input name="monto_auto" type="text" class="itext" id="monto_auto" onchange="conMayusculas(this)"  onkeypress="return acceptNum(event)" value="<? echo $monto;  ?>" size="20" maxlength="255" /></td>
