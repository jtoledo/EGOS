		...
		<!-- 		
 		<div id="iFishEye_example_1"> 
    		 <table>  
            	...
            	<td><a href="../reportes/com_reporte_supervision.php?idcredito=<?php echo $idcredito; ?>"><img class="iFishEyeImg" height="20" width="20" src="../images/excel.png" alt="Reporte de supervision" /><br /><span class="iFishEyeCaption">R. Supervición</span></a></td>  
