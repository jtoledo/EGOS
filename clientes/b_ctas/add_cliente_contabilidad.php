...
$busca_siexiste="select count(*) as regenc from cuentas where idpadre=4448 and ";
...
$Errors="";
if($found['regenc']<=0){
	$cad_insert="select insertar_cuenta(4448,(select max(clave) from cuentas where idpadre=4448)+1,";
	...
	'Alta de cuenta para el cliente:{$q} en la cuenta padre:4448');";
