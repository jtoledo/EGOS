...
?>
<form name="captura" action="" onSubmit="garantiash_alta_egos(2); return false" class="formu">  
...
?>		 
  ...
  <tr>
    <td colspan="7"><textarea class="itextarea_descrip" name="descripcion" id="YourMessage" onChange="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><input name="valor" type="text" class="itext" id="valor" onkeypress="return acceptNum(event)"></td>
    <td colspan="3"><input name="fvaluacion" type="text" id="dateArrivals" onclick="popUpCalendar(this, captura.dateArrivals, 'dd-mm-yyyy');" readonly="readonly" class="itext"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><input type="text" name="registro" size="20"  id="registro" class="itext" onChange="conMayusculas(this)"></td>
    <td width="120" colspan="3"><input type="text" name="libro" size="20" id="libro" class="itext" onChange="conMayusculas(this)"></td>
    <td width="120"><input type="text" name="tomo" size="20"  id="tomo" class="itext" /></td>
    <td width="120"><input type="text" name="seccion" size="20"  id="seccion" class="itext" onChange="conMayusculas(this)"></td>
    <td width="127"><input type="text" name="volumen" size="20"  id="volumen" class="itext" onChange="conMayusculas(this)"></td>
  </tr>
  <tr>
    <td>Superficie</td>
  ...
  <tr>
    <td><input type="text" name="superficie" size="20"  id="superficie" class="itext" onChange="conMayusculas(this)"></td>
...
?>
  ...
  <tr>
    <td colspan="7"><textarea class="itextarea_antes" name="antecedentes" id="antecedentes" onChange="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
    <td colspan="6">&nbsp;</td>
    <td><div align="right">
