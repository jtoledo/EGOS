...
getColonias();
	...
	// Voy imprimiendo el primer select compuesto por los paises
	echo "<select name='localidad' style='width:150px' id='cc_localidades' onChange='carga_select(this.id)' class='peque'>";
	echo "<option value=''>Elige</option>";
	while($registro=pg_fetch_array($consulta))
	{
	...
	*/	
	...
	// Voy imprimiendo el primer select compuesto por los paises
	echo "<select name='colonia'  style='width:150px' id='cc_colonias'  class='peque'>";
	echo "<option value=''>Elige</option>";
	while($registro=pg_fetch_array($consulta))
	{
