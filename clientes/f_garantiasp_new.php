...
?>
<form name="captura" action="" onSubmit="garantiasp_alta_egos(2); return false" class="formu">  
...
?>		 
  ...
  <tr>
    ...
    <select name="idgtias" class="consultor2" onchange="actualiza_garantiap_selec(1); return false">
      ...
      <option value="<?php echo $fila_c["idgtia"]?>"><?php echo nom($desc); ?></option>	
  ...
  <tr>
    <td colspan="8"><textarea class="itextarea_descrip" name="descripcion" id="YourMessage" onChange="conMayusculas(this)"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="5"><input name="valor" type="text" class="itext" id="valor" onkeypress="return acceptNum(event)"></td>
    <td><input name="fregistro" type="text" id="dateArrivals" onclick="popUpCalendar(this, captura.dateArrivals, 'dd-mm-yyyy');" readonly="readonly" class="itext" /></td>
    <td colspan="2"><input name="valuador" type="text" id="valuador"  class="modif" onChange="conMayusculas(this)"></td>
    </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><input type="text" name="marca" size="20" maxlength="255" id="marca" class="modif" onChange="conMayusculas(this)"></td>
    <td colspan="2"><input type="text" name="modelo" size="20" maxlength="255" id="modelo" class="itext" onChange="conMayusculas(this)"></td>
    <td colspan="2"><input type="text" name="estado_actual" size="20" maxlength="255" id="estado_actual" class="modif" onChange="conMayusculas(this)"></td>
    </tr>
  <tr>
  ...
  <tr>
    <td><input type="text" name="no_serie" size="20" maxlength="255" id="no_serie" class="itext" onChange="conMayusculas(this)"></td>
...
?>
    ...
    <td colspan="2"><input name="no_factura" type="text" class="itext" id="no_factura"  onChange="conMayusculas(this)"></td>
    <td colspan="2">&nbsp;</td>
  </tr>
