...
?>
	...
	<form name="captura" action="" onSubmit="guarda_nota_tmp(2); return false" class="formu">  
  ...
  <tr>
    ...
    <td colspan="2">
    	 ...
    	 <?php
    			...
    			get_clientes_nota_m_tmp($idcliente);
    		?></span>
    </td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2"> <div align="center">
      <?php
    	...
    	get_notas_entrada_tmp($idcliente,$_SESSION['mov_sucursal'],$_SESSION['cosecha_sel']);
    ?>
    </div></td>
  </tr>
  <tr>
...
<table border="0" width="100%">
  <tr>
    <td><div class="servicio">
    <?php 
    	get_secado_tmp($id_servicio,$idcliente,$_SESSION['mov_sucursal'],$_SESSION['cosecha_sel']); 
    ?></div></td>
...
<table width="100%" border="1" style="border-collapse:collapse">
  ...
  <tr>
    <td><div align="center">
      <input type="text" name="rendimiento" size="15" maxlength="50" value="0"  id="rendimiento" onkeypress="return acceptNum(event)" autocomplete="off" class="peque" />
    </div></td>
    <td colspan="3"><div align="center">
      <input type="text" name="mancha" size="15" maxlength="50" value="0"  id="mancha" onkeypress="return acceptNum(event)" autocomplete="off" class="peque" />
    </div></td>
    <td><div align="center">
      <input type="text" name="humedad" size="15" maxlength="50" value="0"  id="humedad" onkeypress="return acceptNum(event)" autocomplete="off" class="peque" />
    </div></td>
    <td><div align="center">
