...
if($modif!=1)
{
$fila=get_nota_arreglo_gral($_SESSION['mov_sucursal'],$_SESSION['cosecha_sel']);
...
<table width="100%" border="0">
  <tr>
	...
	EDICI&Oacute;N DE NOTA DE ENTRADA</h2>
	</td><td width="30%">
		<?php
  ...
  <tr>
    <td colspan="8"><div align="center">CONDICIONES DE INACEPTABILIDAD Y DETECCIÓN DE CONTAMINANTES</div></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">ELEMENTOS ORGÁNICOS</td>
    <td><div align="center"></div></td>
    <td>&nbsp;</td>
    <td>ELEMENTOS INORGÁNICOS</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
echo "<input name='desechos_human' type='checkbox' id='desechos_human' value='1' >";
    ...
    <td>&nbsp;</td>
    <td>Vehículo sucio con químico</td>
    <td>
...
<table width="100%" border="1" style="border-collapse:collapse" id="myTable">
  ...
  <tr>
    <td><div align="center">Henequén</div></td>
...
<table width="100%" border="0" >
  <tr>
    <td>RESULTADOS DE ANÁLISIS FÍSICOS</td>
    <td align="right">RESULTADOS DE ANÁLISIS SENSORIAL</td>
  </tr>
</table>
...
echo "<input name='costalera' type='radio' id='costalera' value='3' >";
   ...
   <tr>
     ...
     <td align="center"><strong>Nota de Entrada</strong></td>
     <td align="right">&nbsp;</td>
     <td align="right">&nbsp;</td>
   </tr>
   <tr>
...
{
	echo "<font color='red'>No hay servicios para esta nota</font>";
}
...
<td align="center">
			...
			<input type="checkbox" onclick="if(this.checked){ document.getElementById('reppro').href='../reportes/reporte_nota.php?id_compra=<?php echo $id_compra; ?>&proveedor=1' } else { document.getElementById('reppro').href='../reportes/reporte_nota.php?id_compra=<?php echo $id_compra; ?>&proveedor=0' }"> Con intermediario<br/>
			<a id="reppro" name="reppro" href="../reportes/reporte_nota.php?id_compra=<?php echo $id_compra; ?>&proveedor=0&frm=0">  
			<strong><span class="Estilo1">
				<img src="../images/excel.png" alt="Reporte Nota de entrada"  title="Nota de entrada" width="40px" height="40px">
			</span></strong>  
			</a>
			<a id="reppro" name="reppro" href="../reportes/reporte_nota.php?id_compra=<?php echo $id_compra; ?>&proveedor=0&frm=1">  
			<strong><span class="Estilo1">
				<img src="../images/excel.png" alt="Reporte Nota de entrada"  title="Nota de entrada en Blanco" width="40px" height="40px">
			</span></strong>  
			</a>
	 
</td>
     <td align="right"><div align="center">
       <input class="ibutton" type="button" name="nuevo2" id="nuevo" value="NUEVA NOTA"  onclick="actualiza_nota_cliente(<?php echo $idcliente; ?>,2); return false" />
     </div></td>
     <td align="right"><div align="center">
       <input type='submit' name='enviar' id='enviar' value='MODIFICAR' <?php echo $deshabilita;?> /> 
     </div></td>
    </tr>
 </table>
</form>
