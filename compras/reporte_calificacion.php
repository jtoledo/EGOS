...
<form name="captura" action="" onSubmit="re_genera_calificacion(<?php echo $_SESSION['cosecha_sel']; ?>,<?php echo $_SESSION['mov_sucursal'];?>); return false" class="formu">  
    ...
    <tr>
      <td colspan="2"><li class="iheader">
        ...
        <h2 class="art-logo-text">
          Reporte de Calificación</h2>
        </li>
			<div align="center" id="idproceso">
