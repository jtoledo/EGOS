...
class MYPDF extends TCPDF 
{
	public function Header() 
	{
       ...
       $this->Image($image_file, 10, 5, 15, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		...
		$this->SetFont('helvetica', 'B', 8);
		$this->Cell(0, 2,"CREDITOS ".$grupo,0,1,'C');
		$this->SetFont('helvetica', 'I', 7);
		global $fecha_i;
		global $fecha_f;
...
<?php
$compara=get_credito_grupo($idgrupo,$fecha_i,$fecha_f);
if($compara!=0)
$total=get_credito_grupo_pdf($idgrupo,$fecha_i,$fecha_f);
?>
</table>
...
$pdf->Output('Credito_xGrupo.pdf', 'D');
