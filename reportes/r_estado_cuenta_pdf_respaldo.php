...
class MYPDF extends TCPDF 
{
	public function Header() 
	{
       ...
       $this->Image($image_file, 10, 5, 15, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        ...
        $subtitulo="CARRETERA A NVA. ALEMANIA, KM. 2.5 COL BUROCRÁTICA, TAPACHULA, CHIAPAS";
		...
		$this->SetFont('helvetica', 'B', 8);
		$this->Cell(0, 2,"ESTADO DE CUENTA ".$grupo,0,1,'C');
		global $fecha_i;
		global $fecha_f;
		$this->SetFont('helvetica', 'I', 8);
		$this->Cell(0, 2,"FECHA DE CORTE : ".$fecha_f,0,0,'C');
		$this->SetFont('helvetica', 'I', 7);
		$this->Cell(0, 2,"PERIODO DEL ".$fecha_i." AL ".$fecha_f,0,0,'R');
		
		
		
		$this->Line(9,24,290,23); 
...
$compara=get_credito_cuenta($fecha_i,$fecha_f);
if($compara!=0)
$total=get_credito_cuenta_pdf($fecha_i,$fecha_f);
?>
