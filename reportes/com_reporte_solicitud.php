...
$cliente=$fila["nombre"].' '.$fila["ap_paterno"].' '.$fila["ap_materno"];
...
$fila_solicitud=get_solicitud_m($fila_sol["idsolicitud"]);
$ids_parcelas=$fila_sol["ids_parcelas"];
...
$objPHPExcel = $objReader->load("com_plantilla_solicitud.xlsx");
...
$objPHPExcel->getActiveSheet()->SetCellValue('D16', number_format($fila_credito["monto_parafinanciera"],2));
...
if($stock_parcela==1 and $fila_sol["ids_parcelas"]!="")
{
$objPHPExcel->getActiveSheet()->SetCellValue('C15', $super_total." ha(s)");
...
$objPHPExcel->getActiveSheet()->SetCellValue('A52',$cliente);
