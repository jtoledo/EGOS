...
$sql="SET datestyle TO postgres, dmy; SELECT s.idcliente,s.idestatus,s.t_sol,c.folio,c.f_aprobacion,c.monto,c.idcredito FROM cc_solicitudes as s, cc_creditos as c  where s.idsolicitud=c.idsolicitud and s.idcliente='$idcliente' and c.cancelado='false' and c.f_ministracion<='$fecha_f'  order by c.folio";
