...
$pdf->SetTitle('Procesos y requerimientos del paquete tecnologico');
$pdf->SetSubject('otro');
...
?>
<p align="center">REPORTE GENERAL DE REQUERIMIENTOS DE PAQUETES TECNOL&Oacute;GICOS</p>
...
$consulta_n="SET datestyle TO postgres, dmy; SELECT * FROM paquete_tec,conf_paquete,cc_ptprocesos,cc_unidades where paquete_tec.id_paquete=conf_paquete.id_paquete and cc_ptprocesos.idproceso=conf_paquete.idproceso and cc_unidades.iduni=conf_paquete.iduni  ORDER BY paquete_tec.nom_paquete";
...
$aporta_produ=$fila["aporta_produ"];
	...
	if($conta_paquete>1)			
	$p_paquete=in_array($fila["id_paquete"],$id_paquetes);
	  ...
	  <tr>
		...
		// echo in_array($idproceso,$id_procesos);			
		  ...
		  <td colspan="10" align="center"> <p align="center"><strong><?php 
		  if($p_paquete!=1)
		  echo $fila["nom_paquete"]; ?>
          </strong></p> </td>
		  </tr>
...
$pdf->Output('Reporte_paquete.pdf', 'D');
