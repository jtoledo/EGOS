...
$document = $PHPWord->loadTemplate('com_plantilla_recibo.docx');

$document->setValue('nombre', $nombre_cliente);

$document->setValue('monto', $monto_credito);
//$document->setValue('monto', "           ");

$document->setValue('monto_letra', $monto_letra);
//$document->setValue('monto_letra', "                          ");

$document->setValue('get_fecha', $fecha);
//$document->setValue('get_fecha', "                     ");
$document->setValue('grupocli', $grupo);
$document->setValue("codcliente",$fila_cliente["idcliente"]);

//$super_total
//$document->setValue('super_total',"                 ");
//$document->setValue('super_total',"            ");
