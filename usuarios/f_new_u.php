    ...
    <div align="center">
      <table width="651" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="324">
            <input type="text" name="nombre" id="nombre" size="50" maxlength="60" value="" autocomplete="off" class="itext" onChange="conMayusculas(this)">      </td>
          </tr>			
              <tr>
                <th>			
                <label for="YourName">Iniciales</label></th>
          <td><input  type="text" name="iniciales" id="iniciales" size="8" maxlength="30" value="" autocomplete="off" class="itext" onChange="conMayusculas(this)">      </td>
          </tr>
		  ...
		  $consulta=
				"SELECT nombre_perfil,id_perfil from perfiles order by id_perfil ";
						...
						?>
                  <option value="<?php echo $fila["id_perfil"]?>"><?php echo nom($fila["nombre_perfil"]); ?></option>
                  <?php
